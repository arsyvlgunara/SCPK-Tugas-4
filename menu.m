...
% Last Modified by GUIDE v2.5 09-Mar-2020 18:53:12
...
% --- Executes on button press in mnKabisat.
function mnKabisat_Callback(hObject, eventdata, handles)
% hObject    handle to mnKabisat (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
close
tahunkabisat

% --- Executes on button press in mnBalok.
function mnBalok_Callback(hObject, eventdata, handles)
% hObject    handle to mnBalok (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
close
balok

% --- Executes on button press in mnExit.
